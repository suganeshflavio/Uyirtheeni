    ...
    const handlesubmit = (e) => {
        ...
        axios.post(`https://api.uyirtheeni.com/customer/sendEmailCode`, { email }, { headers: { "authtoken": `${token}` } }).
            then((res) => {
                ...
                else if (res.data.data == "User Not found") {
                    setErr(res.data.data)
                }
            })
    }
                    ...
                    <div class="content">
                        ...
                        <ul class="form-list">
                            ...
                            <li>
                                ...
                                <div class="input-box">
                                    <input type="text" name="login[username]" id="email"  value={email} onChange={(e) => setEmail(e.target.value)} class="input-text required-entry validate-email" placeholder='Enter your email' title="Email Address" />
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="buttons-set">
                            ...
                            <button type="submit" class="button login" name="send" id="send2"><span>Next</span></button>

                            {/* <a href="/forgotpassword" class="forgot-word">Already have an account ?</a> */}
                        </div> <span style={{ color: "red" }}> {err}</span>
                        {/* <!--buttons-set--> */}
                    </div>
                    {/* <!--content--> */}
                </div>
